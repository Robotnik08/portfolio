...
export class TileData {
    constructor () {
        this.texture = {};
        const stone = new THREE.TextureLoader().load( 'project_assets/projects_source/Voxel/images/stone.png' );
        ...
        const dirt = new THREE.TextureLoader().load( 'project_assets/projects_source/Voxel/images/dirt.png' );
        ...
        const grass = new THREE.TextureLoader().load( 'project_assets/projects_source/Voxel/images/grass.png' );
        ...
        const grass_top = new THREE.TextureLoader().load( 'project_assets/projects_source/Voxel/images/grass_top.png' );
