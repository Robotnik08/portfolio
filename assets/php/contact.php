...
<?php include_once 'assets/html/header.php'; ?>
        <script src="assets/js/block-background.js" type="module" defer></script>
            ...
            <div class="w-full h-full absolute content overflow-hidden">
                <div class="main-wrapper w-full h-full flex items-center center justify-center terminal flex-col text-white m-auto">
                    <div id="main" class="terminal-window w-[90%] h-[95%] md:w-3/4 md:h-[90%] terminal overflow-y-auto overflow-x-hidden">
                        <h1 class="text-7xl text-center">Contact</h1>
                        <p class="text-3xl md:text-4xl my-3">You can contact me through the following platforms:</p>
                        <div class="items">
                            <p class="text-2xl md:text-4xl my-1">Email: sebastiaanheins@gmail.com</p>
                            <p class="text-2xl md:text-4xl my-1">GitHub: <a href="https://github.com/Robotnik08/" class='link'>Robotnik08</a></p>
                            <p class="text-2xl md:text-4xl my-1">LinkedIn: <a href="https://www.linkedin.com/in/sebastiaan-heins-a413b8262/" class='link'>sebastiaan-heins</a></p>
                            <p class="text-2xl md:text-4xl my-1">Discord: robotnik05</p>
                        </div>
                        <a href="/" class="text-5xl md:text-7xl text-green-400 hover:text-green-500">↩ Go back to the ship</a>
                    </div>
                </div>
            </div>
