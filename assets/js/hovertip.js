...
// All the tips are below this line
...
if (chessTip != null) {
    chessTip.addEventListener("mouseover", () => {
        showTip("Try to beat him in the demo below!");
    });
    
    chessTip.addEventListener("mouseout", () => {
        hideTip();
    });
}
